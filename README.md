...
Inno 라이브러리 의존성은 로컬 path package가 아니라 각 프로젝트 manifest의 remote package 고정 방식으로 소비합니다. 현재 기준 pin은 InnoDI 6.0 assisted-factory 파일럿 revision `6de46b4afb961c3741b4146023a4c0b262f6d0cc`, `InnoFlow 5.1.0`, `InnoNetwork 5.0.0`, `InnoRouter 5.2.1`입니다.
...
| --- | --- | --- |
| `InnoDI` | `6.0 pilot @ 6de46b4` | 기존 hierarchy/container surface, experimental assisted factory, Xcode/Tuist DAG validation plugin |
...
- generated workspace resolution: InnoDI revision `6de46b4afb961c3741b4146023a4c0b262f6d0cc` 및 나머지 exact version과 일치
