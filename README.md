...
Inno 라이브러리 의존성은 로컬 path package가 아니라 각 프로젝트 manifest의 remote package 고정 방식으로 소비합니다. 현재 기준 pin은 InnoDI 6.0 container-host 파일럿 revision `eaee869c4518fd2cd102e6ec750a05cde16c50ac`, `InnoFlow 5.1.0`, `InnoNetwork 5.0.0`, `InnoRouter 5.2.1`입니다.
...
| --- | --- | --- |
| `InnoDI` | `6.0 pilot @ eaee869` | 공개 `@Input(.assisted)`·`@AssistedFactory`·`DIContainerHost`, Xcode/Tuist DAG validation plugin |
...
- generated workspace resolution: InnoDI revision `eaee869c4518fd2cd102e6ec750a05cde16c50ac` 및 나머지 exact version과 일치
